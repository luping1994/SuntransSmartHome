...
import net.suntrans.suntranssmarthome.databinding.FragmentEnvDetailBinding;
...
public class Env_fragment extends Fragment {
    ...
    public static Env_fragment newInstance(SensusResult.Sensus result) {
...
//        View view = inflater.inflate(R.layout.fragment_nav_env, container, false);
//        ButterKnife.bind(this, view);
        this.info = getArguments().getParcelable("info");
    ...
    public void onViewCreated(View view, @Nullable Bundle savedInstanceState) {
        ...
        binding.progressBar1.setText(info.getPm25() == null ? "" : info.getPm25());
        binding.progressBar1.setProgressColor(Color.parseColor("#5bb7e2"));
        binding.progressBar.setProgressColor(Color.WHITE);
        binding.progressBar1.setProgress(info.getPm25() == null ? 0 : Float.valueOf(info.getPm25()).intValue());
        binding.progressBar.setProgress(info.getShidu() == null ? 0 : Float.valueOf(info.getShidu()).intValue());
        binding.progressBar.setText(info.getShidu() + "%");
