...
public class MySwitch extends CompoundButton {
    ...
    /**
     * Width required to draw the switchs track and thumb. Includes padding and
     * optical bounds for both the track and thumb.
     */
    private int mSwitchWidth;

    /**
     * Height required to draw the switchs track and thumb. Includes padding and
     * optical bounds for both the track and thumb.
     */
    ...
    /** Left bound for drawing the switchs track and thumb. */
    private int mSwitchLeft;

    /** Top bound for drawing the switchs track and thumb. */
    private int mSwitchTop;

    /** Right bound for drawing the switchs track and thumb. */
    private int mSwitchRight;

    /** Bottom bound for drawing the switchs track and thumb. */
    ...
    public MySwitch(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        PorterDuff.Mode thumbTintMode = net.suntrans.suntranssmarthome.widget.DrawableUtils.parseTintMode(
    ...
    /**
     * Sets the switchs text color, size, style, hint color, and highlight color
     ...
     * switchs, and turns on the fake bold and italic bits in the Paint if the
    ...
    /**
     * Sets the typeface in which the text should be displayed on the switchs.
    ...
    /**
     * Set the amount of horizontal padding between the switchs and the associated text.
     *
    ...
    /**
     * Get the amount of horizontal padding between the switchs and the associated text.
     *
    ...
    /**
     * Set the minimum width of the switchs in pixels. The switchs's width will be the maximum
     * of this value and its measured width as determined by the switchs drawables and text used.
     *
     * @param pixels Minimum width of the switchs in pixels
     *
    ...
    /**
     * Get the minimum width of the switchs in pixels. The switchs's width will be the maximum
     * of this value and its measured width as determined by the switchs drawables and text used.
     *
     * @return Minimum width of the switchs in pixels
     *
     * @attr ref android.support.v7.appcompat.R.styleable#SwitchCompat_switchMinWidth
     */
    ...
    /**
     * Set the horizontal padding around the text drawn on the switchs itself.
     *
     * @param pixels Horizontal padding for switchs thumb text in pixels
     *
    ...
    /**
     * Get the horizontal padding around the text drawn on the switchs itself.
     *
     * @return Horizontal padding for switchs thumb text in pixels
     *
     * @attr ref android.support.v7.appcompat.R.styleable#SwitchCompat_thumbTextPadding
     */
    ...
    /**
     * Set the drawable used for the track that the switchs slides within.
     *
    ...
    /**
     * Get the drawable used for the track that the switchs slides within.
     *
    ...
    /**
     * Set the drawable used for the switchs "thumb" - the piece that the user
    ...
    /**
     * Get the drawable used for the switchs "thumb" - the piece that the user
     * can physically touch and drag along the track.
     *
    ...
    /**
     * @return true if (x, y) is within the target area of the switchs thumb
     */
    ...
    private void stopDrag(MotionEvent ev) {
        ...
        // Commit the change if the event is up and not canceled and the switchs
